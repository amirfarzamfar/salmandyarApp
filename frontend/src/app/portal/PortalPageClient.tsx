...
export default function PortalPageClient() {
  ...
  const highlightedDoseIdParam = searchParams.get("doseId");
  const highlightedDoseId = highlightedDoseIdParam ? Number(highlightedDoseIdParam) : null;
        ...
        >
          ...
          <motion.section variants={itemVariants}>
            <MedicationTimeline
              ...
              highlightedDoseId={Number.isFinite(highlightedDoseId) ? highlightedDoseId : null}
            />
          </motion.section>
