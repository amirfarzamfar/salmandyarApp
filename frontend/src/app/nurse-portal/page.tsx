  ...
  return (
    <div className="space-y-6 px-4 md:px-0 pb-24">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <Link href="/nurse-portal/patient-management" className="flex items-center gap-3 p-4 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 rounded-[1.5rem] border border-emerald-100 dark:border-emerald-800/30 group col-span-1">
            <div className="w-10 h-10 rounded-xl bg-white dark:bg-emerald-900/30 flex items-center justify-center text-emerald-500 shadow-sm group-hover:scale-110 transition-transform">
              <Activity size={20} />
            </div>
            <div className="min-w-0">
              <div className="text-sm font-black text-gray-800 dark:text-gray-200 truncate">مدیریت بیماران</div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 font-bold truncate">لیست و ثبت علائم</div>
            </div>
          </Link>
