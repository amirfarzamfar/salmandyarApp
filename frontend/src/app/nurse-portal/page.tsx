  ...
  return (
    <div className="space-y-6 px-4 md:px-0 pb-24">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-3">
          <Link href="/nurse-portal/vital-signs" className="flex items-center gap-3 p-4 bg-gradient-to-br from-emerald-50 to-emerald-100/50 dark:from-emerald-900/20 dark:to-emerald-800/10 rounded-[1.5rem] border border-emerald-100 dark:border-emerald-800/30 group col-span-1">
            ...
            <div className="min-w-0">
              <div className="text-sm font-black text-gray-800 dark:text-gray-200 truncate">علائم حیاتی</div>
              <div className="text-[10px] text-gray-500 dark:text-gray-400 font-bold truncate">ثبت سریع وضعیت</div>
            </div>
          </Link>
