...
export const healthTools: HealthTool[] = [
  {
    ...
    name: 'ماشین حساب BMI',
    slug: 'bmi-calculator',
    shortDescription: 'محاسبه شاخص توده بدنی برای سالمندان و بزرگسالان',
    description: 'محاسبه BMI (شاخص توده بدنی) بر اساس قد و وزن با تفسیر مخصوص سالمندان.',
    toolType: 'Calculator',
    howToUse: 'قد خود را به سانتی‌متر و وزن را به کیلوگرم وارد کنید و دکمه محاسبه را بزنید.',
    interpretationGuide:
      'برای سالمندان BMI بین ۲۲ تا ۲۷ ایده‌آل است. BMI کمتر از ۲۲ نشانه کمبود وزن و بیشتر از ۳۰ چاقی محسوب می‌شود.',
    disclaimers:
      'این ابزار صرفاً جهت اطلاع عمومی است و نباید جایگزین مشاوره پزشک شود.',
    metaTitle: 'محاسبه BMI سالمندان | ماشین حساب شاخص توده بدنی | سالمندیار',
    metaDescription:
      'ماشین حساب رایگان BMI برای سالمندان و بزرگسالان. تعیین وضعیت وزنی و پیشنهادهای بهداشتی متناسب.',
  },
  {
    id: 2,
    name: 'امتیازبندی GCS',
